export const ErrorCode = {
    ...
    GENERAL_INVALID_HEX_COLOR_FIELD: 'Cor inválida!',
    GENERAL_INVALID_URL_FIELD: 'URL inválida!',
    GENERAL_INVALID_EMAIL_FIELD: 'Email inválido!',
    GENERAL_INVALID_DATE_FIELD: 'Data inválida!',
} as const
